...
public class FortnightdetailsActivity extends BaseActivity {
    LottieAnimationView animationView;
    NestedScrollView scrollView1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fortnightdetails);
        ...
        private void getanimalList (String userid){
            ...
            call.enqueue(new Callback<ProductdataResponse>() {
                ...
                public void onResponse(@NonNull Call<ProductdataResponse> call, @NonNull Response<ProductdataResponse> response) {
                    ...
                    if (response.code() == 200) {
                        ...
                        if (response.body().isStatus()) {
                            ...
                            Toast.makeText(FortnightdetailsActivity.this, "Something went wrong try after sometimes!", Toast.LENGTH_SHORT).show();
                        }
                    } else if (response.code() == 401) {
                        hideLoading();
                        Toast.makeText(FortnightdetailsActivity.this, "Error", Toast.LENGTH_SHORT).show();
                    } else {
                        hideLoading();

                        Toast.makeText(FortnightdetailsActivity.this, "Error1*", Toast.LENGTH_SHORT).show();
                    }
                }
                ...
                public void onFailure(@NonNull Call<ProductdataResponse> call, @NonNull Throwable t) {
                    hideLoading();
                    Toast.makeText(FortnightdetailsActivity.this, "Exception" + t, Toast.LENGTH_SHORT).show();
                }
            });
        }
    }